...
import com.telran.worldcitiesapp.model.CompositePrimaryKeys;
...
@Repository
public interface CountryLanguageRepository extends JpaRepository<CountryLanguage, CompositePrimaryKeys> {
